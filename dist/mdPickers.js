...
module.constant("mdpIconsRegistry", [
    ...
    },
    {
        ...
        id: 'mdp-arrow-drop-down',
        url: 'mdp-arrow-drop-down.svg',
        svg: '<svg height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/><path d="M0 0h24v24H0z" fill="none"/></svg>'
    }, {
        id: 'mdp-arrow-drop-up',
        url: 'mdp-arrow-drop-up.svg',
        svg: '<svg height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 14l5-5 5 5z"/><path d="M0 0h24v24H0z" fill="none"/></svg>'
    }
]);
...
module.directive("mdpCalendar", ["$animate", function($animate) {
    return {
        ...
        template: '<div class="mdp-calendar">' +
                    ...
                    '</div>' +
                    '<div layout="row" layout-align="start center" layout-wrap class="mdp-calendar-days" ng-class="{ \'mdp-animate-next\': calendar.animating }" ng-show="!calendar.animating" ng-swipe-left="calendar.nextMonth()" ng-swipe-right="calendar.prevMonth()">' +
